...
public abstract class Event implements Runnable {
    ...
    public final void host(Player player, PlayerKitProfile profile) {
    ...
    public final void join(Player player, PlayerKitProfile profile) {
    ...
    public final void spectate(Player player, PlayerKitProfile profile) {
        profile.setState(PlayerState.EVENT);
        profile.setActiveEvent(this);
    ...
    public final void leave(Player player, PlayerKitProfile profile) {
